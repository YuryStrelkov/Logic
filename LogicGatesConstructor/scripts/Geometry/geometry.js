...
import { DEG_TO_RAD, NUMERICAL_ACCURACY } from "../VisualObjects/common.js"; 
/**
 * Двумерный вектор.
 */
...
export default class Vector3d
{
	...
	{
		const i_length = this.inv_length;
		return new Vector3d(this.x * i_length, this.y * i_length, this.z * i_length);
	}
	normalize()
	{
		const i_length = this.inv_length;
...
export default class Matrix3d
{
	...
	v_mul(other)
	{
		return new Vector3d(this.m00 * other.x + this.m01 * other.y + this.m02 * other.z,
						    this.m10 * other.x + this.m11 * other.y + this.m12 * other.z,
						    this.m20 * other.x + this.m21 * other.y + this.m22 * other.z);
	}
	rv_mul(other)
	{
		return new Vector3d(this.m00 * other.x + this.m10 * other.y + this.m20 * other.z,
